...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        bouton_sauvegarde = new QPushButton(tab_couleurPage1_2);
        bouton_sauvegarde->setObjectName(QStringLiteral("bouton_sauvegarde"));

        horizontalLayout->addWidget(bouton_sauvegarde);
        ...
        bouton_manueln->setCursor(QCursor(Qt::PointingHandCursor));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        bouton_sauvegarde->setText(QApplication::translate("MainWindow", "Sauvegarder Historique", 0));
        ...
        comboBox->insertItems(0, QStringList()
         << QApplication::translate("MainWindow", "Image Originale", 0)
         << QApplication::translate("MainWindow", "Compl\303\251ment", 0)
         << QApplication::translate("MainWindow", "Erosion", 0)
         << QApplication::translate("MainWindow", "Inversion", 0)
        );
        comboBox_2->clear();
        comboBox_2->insertItems(0, QStringList()
         << QApplication::translate("MainWindow", "Image Originale", 0)
         << QApplication::translate("MainWindow", "Expansion", 0)
         << QApplication::translate("MainWindow", "Seuiller", 0)
        );
        ...
        pushButton->setText(QApplication::translate("MainWindow", "Expansion", 0));
